...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  // sql statement untuk menampilkan data "no_antrian" dari tabel "tbl_antrian" berdasarkan "tanggal" dan "status = 1" dan "Pelayanan"
  $query = mysqli_query($mysqli, "SELECT no_antrian FROM tbl_antrian 
                                  WHERE tanggal='$tanggal' AND status='1' AND loket='Pelayanan Publik' 
