...
<body class="d-flex flex-column h-100 align-content-center">
  <main class="flex-shrink-0">
    <div class="container pt-2">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm justify-content-between">
        <!-- judul halaman -->
        <div class="d-flex align-items-start">
          <img src="../assets/img/BTAM.png" alt="" width="200px">
          <!-- <h1 class="h5 pt-2">Panggilan Antrian</h1> -->

        </div>
        <!-- Jam -->
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <div class="digital-clock fw-500 mx-5 fs-3">00:00:00</div>
        </div>
      </div>
      ...
      <div class="row justify-content-center mt-2">
          ...
          <div class="card border-0 shadow-sm bg-success">
            <div class="card-body p-4">
              <div class="d-flex justify-content-center head">
                <div class="feature-icon-3 me-4">
                  <i class="bi-megaphone text-dark"></i>
                </div>
                <h3 class="fw-bold mt-4">NOMOR ANTRIAN</h3>
              </div>

              <div>
                <p id="antrian-sekarang" class="text-num1 fw-bolder "></p>
              </div>
              <p class="mb-0 fs-3 fw-bold p-1 mb-1 text-white blink_me">Panggilan Antrian</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div class="feature-icon-2 rounded-circle bg-info">
                <i class="bi-person-check text-white"></i>
              </div>
              <div class="d-flex justify-content-center ">

                <div>
                  <p id="loket-pelayanan" class="text-num2 fw-bolder  "></p>
                  <p class="mb-0 fs-4 fw-bold border-top p-3">Pelayanan Publik</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              ...
              <div class="d-flex justify-content-center">
                ...
                <div>
                  <p id="loket-pengaduan" class="text-num2 fw-bolder "></p>
                  <p class="mb-0 fs-4 fw-bold border-top p-3">Informasi dan Pengaduan</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 mb-4">
          <div class="card border-0 shadow-sm bg-primary">
            <div class="card-body p-4">
              <div class="d-flex justify-content-center head">
                <div class="feature-icon-3 me-4">
                  <i class="bi-person-plus text-primary"></i>
                </div>
                <p class="mb-0 fs-5 fw-bold mt-4 text-primary">ANTRIAN SELANJUTNYA</p>
              </div>

              <div>
                <p id="antrian-selanjutnya" class="fs-1 text-num3 mb-1 fw-bolder"></p>
              </div>
          ...
          <div class="card border-0 shadow-sm bg-danger">
            <div class="card-body p-4">
              <div class="d-flex justify-content-center head">
                ...
                <p class="mb-0 fs-5 fw-bold text-danger mt-4 text-center">SISA ANTRIAN</p>
              </div>

              <div>
                <p id="sisa-antrian" class="fs-1 text-num3 mb-1 fw-bolder"></p>
              </div>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#loket-pelayanan').load('get_antrian_pelayanan.php');
      $('#loket-pengaduan').load('get_antrian_informasipengaduan.php');
      ...
      $('#tabel-antrian tbody').on('click', 'button', function () {
        ...
        setTimeout(function () {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket",
            "Indonesian Female", {
              rate: 1,
              pitch: 1,
              volume: 1
      ...
      setInterval(function () {
        ...
        $('#loket-pelayanan').load('get_antrian_pelayanan.php').fadeIn("slow");
        $('#loket-pengaduan').load('get_antrian_informasipengaduan.php').fadeIn("slow");
