...
<head>
  ...
  <!-- Title -->
  <title>Informasi dan Pengaduan</title>
    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Panggilan Antrian Loket Informasi dan Pengaduan</h1>
        </div>
        <!-- breadcrumbs -->
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Antrian Informasi dan Pengaduan</li>
            </ol>
          </nav>
        </div>
      </div>
