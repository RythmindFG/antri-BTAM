        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>Nomor Antrian</h3>
              <p class="mb-4">Halaman Nomor Antrian digunakan pengunjung untuk mengambil nomor antrian Pelayanan maupun Pengaduan.</p>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <h3>Buku Tamu</h3>
              <p class="mb-4">Halaman Buku Tamu digunakan untuk mengetahui seberapa banyak orang berkunjung ke Balai Teknologi Air Minum.</p>
              <a href="http://bukutamu.paperform.co" class="btn btn-success rounded-pill px-4 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
